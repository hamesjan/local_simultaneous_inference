...
def get_model(name: str):
    ...
    # if name.startswith("ollama:") or name.startswith("llama3.2:"):
    #     # accept names like "ollama:llama3.2:1b" or "llama3.2:1b"
    #     model_name = name if ":" in name else f"llama3.2:{name}"
